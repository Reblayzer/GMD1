...
| Field                                     | Description                                                                                                                            |
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Player Experience and Game POV            | The game will have a third perspective POV where the camera will be facing the carcter down from a 45 degree angle                     |
...
| Objectives and Progression | The player must collect all Ethereal Shards in a level to unlock the exit. Hidden collectibles (e.g., keys to progress in the level) deal as additional obstacles in the level.                      |
| Game Systems               | - Movement: Rolling and jumping. <br> - Puzzles: Deactivate energy barriers, navigate moving platforms, and avoid environmental hazards. <br> - Progression: Unlock new levels by collecting Shards. |
| Interactivity              | - Player moves on all axes (3D movement). <br> - Player collects Ethereal Shards and hidden collectibles. <br> - Player interacts with environmental objects (e.g., switches, moving platforms).     |
